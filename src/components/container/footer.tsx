...
const Footer = () => {
  return (
    <>
      <footer className=" pb-10  sm:pb-15 flex items-center border-t  *:px-5 lg:*:px-24.5 border-t-grey-30 flex-col w-full gap-24">
        ...
        <section className="  w-full">
          <div className="text-white  md:flex-row flex-col font-onest font-medium text-lg sm:text-2xl w-full px-[17px] lg:px-[100px] py-8 sm:py-14 bg-grey-90 rounded-xl flex sm:items-center max-sm:gap-6 justify-between">
            <span>
