...
export function Project_Carousel() {
  return (
    <section className=" flex w-full py-10 sm:py-[100px] flex-col border-b border-b-grey-30 px-5 lg:px-24.5 items-start justify-start">
                ...
                <div className="flex md:flex-row flex-col md:px-5 items-start text-button-color justify-between w-full gap-3 sm:gap-8 text-left">
                  <div className="flex flex-col gap-6">
                    ...
                    <Link
                      ...
                      className="font-sans font-bold text-xl underline sm:leading-11.5"
                    >
                      VIEW PROJECT
                    </Link>
                  </div>
